// ArduinoISP lowspeed with Auto-Reset
// Customizations by EmulationOnline
// Usage is explained in detail on my site at
// https://emulationonline.com/systems/chiplab/flashing-arduino-bootloader
//
// Original ArduinoISP
